...
from database.tables import CREATE_TEACHERS_TABLE, CREATE_CLASSROOMS_TABLE, CREATE_STUDENTS_TABLE,\
    ...
    DROP_TASKS_TABLE, DROP_TASK_MESSAGES_TABLE, DROP_SUBMISSIONS_TABLE, DROP_SUBMISSION_MESSAGES_TABLE, \
...
def init_database():
    if settings.DEBUG:
        commands = [CREATE_TEACHERS_TABLE, CREATE_STUDENTS_TABLE, CREATE_CLASSROOMS_TABLE,
                    CREATE_CLASSROOM_STUDENTS_TABLE, CREATE_TASKS_TABLE, CREATE_TASK_MESSAGES_TABLE,
                    CREATE_SUBMISSIONS_TABLE, CREATE_SUBMISSION_MESSAGES_TABLE, CREATE_SUBMISSION_REVIEW_MESSAGES_TABLE]
        # commands = [DROP_SUBMISSION_REVIEW_MESSAGES_TABLE, DROP_SUBMISSION_MESSAGES_TABLE, DROP_SUBMISSIONS_TABLE,
        #             DROP_TASK_MESSAGES_TABLE, DROP_TASKS_TABLE, DROP_CLASSROOM_STUDENTS_TABLE,
